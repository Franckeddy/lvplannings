...
const htmlDay6 = fs.readFileSync('html-2026-06-06.txt', 'utf-8');
const htmlDay7 = fs.readFileSync('html-2026-06-07.txt', 'utf-8');
...
console.log('\n📅 Parsing 6 juin...');
const day6 = parseHTMLString(htmlDay6, '2026-06-06');
console.log(`   ✅ ${day6.length} tournois extraits`);

console.log('\n📅 Parsing 7 juin...');
const day7 = parseHTMLString(htmlDay7, '2026-06-07');
console.log(`   ✅ ${day7.length} tournois extraits`);

const allTournaments = [...day4, ...day5, ...day6, ...day7];
...
console.log('\n📋 Exemples (premiers 3 tournois du 7 juin):');
day7.slice(0, 3).forEach((t, i) => {
  console.log(`\n${i + 1}. ${t.casino}`);
